...
const { loginController, registerController, logoutController, updateUserController, deleteUserController, sendOtpController } = require('../controllers/auth.controller');
